<?php view('admin.layouts.header', ['title' => trans('admin.news') . ' - ' . trans('admin.edit')]);
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div
        ...
        <h2>{{trans('admin.news')}} / {{trans('admin.edit') .' #'. $news['id']}}</h2>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="description" placeholder="{{trans('news.description')}}"
                        class="form-control <?php echo !empty($description) ? 'is-invalid' : 'is-valid'; ?>">{{$news['description']}}</textarea>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="content" id="content" placeholder="{{trans('news.content')}}"
                        class="form-control <?php echo !empty($content) ? 'is-invalid' : 'is-valid'; ?>">{{$news['content']}}</textarea>
                </div>
            </div>
            <script>
                ClassicEditor
    ...
    <form method="post" action="<?php echo aUrl('news/delete?id=' . $news['id']) ?>" enctype="multipart/form-data">
        <input type="hidden" name="_method" value="post" />
