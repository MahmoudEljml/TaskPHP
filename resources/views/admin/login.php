...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        ...
        <form method="post" action="{{url(ADMIN.'/do/login')}}">
            ...
            <img class="mb-4 mx-auto d-flex " src="{{url('assets/admin')}}/assets/brand/bootstrap-logo.svg" alt=""
                width="72" height="57">
            ...
            <p class="mt-5 mb-3 text-body-secondary">&copy; 2017–2025
    ...
    <script defer src="{{url('assets/admin')}}/assets/dist/js/bootstrap.bundle.min.js"
