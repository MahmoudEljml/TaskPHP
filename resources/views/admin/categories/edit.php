<?php view('admin.layouts.header', ['title' => trans('admin.categories') . ' - ' . trans('admin.edit')]);
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div
        ...
        <h2>{{trans('admin.categories')}} / {{trans('admin.edit') .' #'. $category['id']}}</h2>
    ...
    <form method="post" action="<?php echo aUrl('categories/edit?id=' . $category['id']) ?>"
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="description" placeholder="{{trans('cat.desc')}}"
                        class="form-control <?php echo !empty($description) ? 'is-invalid' : 'is-valid'; ?>">{{$category['description']}}</textarea>
    ...
    <form method="post" action="<?php echo aUrl('categories/delete?id=' . $category['id']) ?>"
        enctype="multipart/form-data">
        <input type="hidden" name="_method" value="post" />
