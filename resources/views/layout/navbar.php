            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page"
                        href="<?php echo url('/') ?>"><?php echo trans('main.home') ?></a>
                </li>
                <li class="nav-item">
                ...
                <?php if (session('locale') == 'en'): ?>
                    <li><a class="nav-link" href="<?php echo url('lang?lang=ar') ?>"><?php echo trans('main.arabic') ?></a>
                    </li>
                <?php else: ?>
                    <li><a class="nav-link" href="<?php echo url('lang?lang=en') ?>"><?php echo trans('main.english') ?></a>
                    </li>
                <?php endif; ?>
