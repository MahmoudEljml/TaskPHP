...
if (!function_exists('storage')) {
    ...
    {
        if (file_exists($path)) {
            header('Content-Description: fil from server');
...
if (!function_exists('delete_file')) {
    function delete_file($to_path): bool
    {
...
if (!function_exists('remove_folder')) {
    function remove_folder($path): bool
    {
        if (is_dir($path)) {
            return rmdir($path);
        }
...
if (!function_exists('store_file')) {
    function store_file(array $from, string $to)
    {
